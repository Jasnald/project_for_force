...
%% Diese Werte Vorher festlegen
    ...
    trigger = 30; %Triggerwert zur Signalerkennung
    est_total_cutting_time = 4; %Geschätzte gesamteingriffszeit für alle Dimple in Sekunden
    max_eingriffzeit_dimple = 0.3; %in Sekunden, beschreibt die Dauer, die z.B. ein einzelner Dimple oder Verzahnung gefräst wird. (Der Abstand zwischen zwei Fräsungen soll fertigungsbedingt größer sein, als die Eingriffszeit)
...
path = uigetdir('..\..\..\02_Kraftdaten\ASSA ABLOY\PS4',"Ordener der .tdms Dateien wählen");
path = append(path,'\');
datatype = 'tdms';
...
%         end
    ...
    %Mittelwert für jeweils die tiefen und die flachen Dimple für F_zer
    ...
    % table_mean = table(dimple_flat_mean,dimple_deep_mean);
